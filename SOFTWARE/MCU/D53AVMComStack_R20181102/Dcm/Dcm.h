...
*******************************************************************************/
/*PowerOn security access delay  force*/
#define  DCM_POWERONSECURITYACCESSDELAYFORCE                        STD_ON
/*SecurityAcessAttempNumber provided by app*/
//#define  DCM_SECACCESSNUMPROVIDEDBYAPP                              STD_OFF
//#define DCM_POWERONATTEMPNUMBER_CONTINUE                            STD_ON
...
//#define DCM_POWERONDELAYTIMER_CONTINUE    STD_ON/*STD_ON: Resume the delay timer;STD_OFF:Restart the delay timer*/          
//#endif

/*Request seed continuous asuse SecurityAcessAttempNumber--*/
#define  DCM_REQUESTSEEDCONTINOUS                                   STD_OFF

/*strict seed -Key sequence */
#define  DCM_STRICTSEEDKEYSEQUENCE                                  STD_ON

#define Dcm_ClearDiagnosticFun              /*DemDcmIf_ClearDiagnosticInformation*/App_ClearDiagnosticInformation
