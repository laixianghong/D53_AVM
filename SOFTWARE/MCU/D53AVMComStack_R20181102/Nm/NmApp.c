...
{
    DDMSetDTCSwitch(DTC_ESP_218_MSG_TIMEOUT_INDEX,DTC_SWITCH_ENABLE);
    DDMSetDTCSwitch(DTC_IP_270_MSG_TIMEOUT_INDEX,DTC_SWITCH_ENABLE);
}
/*******************************************************************************
* Function Name     : 
* Returned Value    :
...
void Appl_IndirNmBusOffStart(void)
{
    ...
    DDMSetDTCSwitch(DTC_ESP_218_MSG_TIMEOUT_INDEX,DTC_SWITCH_DISABLE);
    DDMSetDTCSwitch(DTC_IP_270_MSG_TIMEOUT_INDEX,DTC_SWITCH_DISABLE);
}
/*******************************************************************************
* Function Name     : 
* Returned Value    :
